...
// import { LucideMagnifyingGlass } from "lucide-react";
		...
		<header className="flex items-center justify-between whitespace-nowrap border-b border-b-[#f0f2f5] px-10 py-3">
			...
			<div className="flex flex-1 justify-end gap-8">
				...
				<div className="flex gap-2">
					<Button className="min-w-[84px] max-w-[480px] h-10 bg-[#0c7ff2] text-white text-sm font-bold tracking-[0.015em]">
						Add Key
					</Button>
					<Button
						variant="outline"
